...
export const AREAS = [
    ...
    // ═══ QUIÉN ENTRA Y QUÉ PUEDE ════════════════════════════════════════════
    {
        ...
        archivos: [
            ...
            'src/utils/kioskGrace.js', 'src/utils/kioskSound.js', 'src/utils/carnePrint.js',
    ...
    },
    {
        ...
        tablas: ['cortes_caja', 'cortes_caja_diferencia_personas', 'cortes_caja_diferencias',
                 ...
                 'bolsas', 'bolsas_entidades', 'bolsas_entregas', 'bolsas_eventos', 'bolsas_movimientos',
                 'bolsas_operaciones', 'bolsas_tipos_salida'],
    ...
    },
    {
        ...
        resumen: 'El producto que se mueve fuera del pedido: la sala pide, otra confirma, y el envío al revés. Incluye el área de vencidos y la sala de respaldo.',
