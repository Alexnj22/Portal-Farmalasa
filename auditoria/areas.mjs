...
export const AREAS = [
    ...
    // ═══ QUIÉN ENTRA Y QUÉ PUEDE ════════════════════════════════════════════
    {
        ...
        archivos: [
            ...
            'src/hooks/useKioskDevice.js', 'src/hooks/useTimeClockEngine.js', 'src/plataforma/useCapturaDeCarne.js',
            'src/utils/kioskGrace.js', 'src/plataforma/kioskSound.js', 'src/utils/kioskAutorizacion.js',
    ...
    // ═══ GENTE ══════════════════════════════════════════════════════════════
    {
        ...
        archivos: [
            ...
            'src/data/prepararDocumento.js', 'src/plataforma/componerDocumento.js',
            'src/utils/formatosDePapel.js',
            'src/plataforma/perspectiva.js',
    ...
    },
    {
        ...
        archivos: [
            ...
            'src/hooks/useNotificationsChannel.js', 'src/plataforma/usePushSubscription.js',
    ...
    },
    {
        ...
        tablas: ['customers', 'customers_changelog', 'customer_activity', 'clientes_por_revisar',
                 ...
                 'puntos_consulta_intentos', 'dte_rechazos_avisados'],
        ...
        crons: ['regularizar-dte-2230-sv', 'sincronizar-fichas-clientes-2130-sv', 'drain-cliente-erp-queue',
                ...
                'refresh-customer-activity-daily', 'avisar-rechazos-mh-8am-sv'],
    ...
    },
    {
        ...
        tablas: ['audit_logs', 'sync_log', 'sync_alert_log', 'backup_sync_log', 'orphan_objects_registry',
                 'security_config', 'export_log', 'reinicios_de_la_base'],
        ...
        crons: ['check-sync-health-alerts-20min', 'backup-critical-tables-weekly', 'purge-sync-logs-daily',
                'purge-cron-history-daily', 'vigilar-reinicio-de-la-base'],
