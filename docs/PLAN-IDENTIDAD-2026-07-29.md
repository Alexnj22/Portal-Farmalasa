...
| F3 | Los 50 `title=` no interactivos | 2.240.0 | `tooltip-no-control` | |
| F4 | Rampa + trazo + marcas de agua | 2.241.0 | `icono-rampa`, `icono-stroke` | |
| F5 | Mapa semántico de íconos | 2.242.0 | `icono-semantico` | |
| F6 | Fuga de excepciones del gate | 2.243.0 | — (arregla el gate) | |
