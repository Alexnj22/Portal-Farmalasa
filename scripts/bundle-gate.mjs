...
const PESADAS = {
  ...
  'leaflet': 'Mapa de respaldo de Rutas — sólo al abrir un mapa. Entró al paquete el 2026-08-08 al sacarlo de unpkg (docs/planes-cerrados/PLAN-SESIONES-SEGURAS-2026-08-08.md F0.1); antes no lo vigilaba nadie porque venía de un CDN.',
