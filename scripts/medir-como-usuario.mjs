...
const LLAMADAS = [
  ...
  // ── Búsqueda (docs/PLAN-BUSQUEDA-UNIFICADA-2026-09-25.md) ──
  // Cada buscador con varios casos: una palabra que existe, la misma mal
  // escrita (la aproximada), un número, y una que no existe en ningún lado
  // — ésa es la cara: lo exacto no trae nada y corre la aproximada entera.
  { clave: 'busq-productos-existe', nota: 'Productos (catálogo) · «amoxicilina»',
    sql: `SELECT public.buscar_productos_ids('amoxicilina', 60, false, false, true)` },
  { clave: 'busq-productos-typo', nota: 'Productos (catálogo) · «amoxisilina»',
    sql: `SELECT public.buscar_productos_ids('amoxisilina', 60, false, false, true)` },
  { clave: 'busq-productos-numero', nota: 'Productos (catálogo) · «500»',
    sql: `SELECT public.buscar_productos_ids('500', 60, false, false, true)` },
  { clave: 'busq-productos-nada', nota: 'Productos (catálogo) · «zzqxwv»',
    sql: `SELECT public.buscar_productos_ids('zzqxwv', 60, false, false, true)` },
  { clave: 'busq-prod-pactivo-existe', nota: 'Productos con principio activo y laboratorio · «losartan»',
    sql: `SELECT public.buscar_productos_ids('losartan', 60, true, true, false)` },
  { clave: 'busq-prod-pactivo-nada', nota: 'Productos con principio activo y laboratorio · «zzqxwv»',
    sql: `SELECT public.buscar_productos_ids('zzqxwv', 60, true, true, false)` },
  { clave: 'busq-inv-global-typo', nota: 'Inicio · buscador de inventario · «amoxisilina»',
    sql: `SELECT public.buscar_inventario_global_v2('amoxisilina', 60)` },
  { clave: 'busq-inv-global-numero', nota: 'Inicio · buscador de inventario · «2.5»',
    sql: `SELECT public.buscar_inventario_global_v2('2.5', 60)` },
  { clave: 'busq-inv-global-nada', nota: 'Inicio · buscador de inventario · «zzqxwv»',
    sql: `SELECT public.buscar_inventario_global_v2('zzqxwv', 60)` },
  { clave: 'busq-inventario-typo', nota: 'Inventario · vista · «amoxisilina»',
    sql: `SELECT * FROM public.inventory_grouped(p_erp_id => NULL, p_search => 'amoxisilina', p_limit => 25)` },
  { clave: 'busq-inventario-numero', nota: 'Inventario · vista · «2.5»',
    sql: `SELECT * FROM public.inventory_grouped(p_erp_id => NULL, p_search => '2.5', p_limit => 25)` },
  { clave: 'busq-inventario-nada', nota: 'Inventario · vista · «zzqxwv»',
    sql: `SELECT * FROM public.inventory_grouped(p_erp_id => NULL, p_search => 'zzqxwv', p_limit => 25)` },
  { clave: 'busq-minmax-existe', nota: 'Mín·Máx · buscador · «losartan»',
    sql: `SELECT * FROM public.buscar_productos_minmax('losartan', 20)` },
  { clave: 'busq-minmax-typo', nota: 'Mín·Máx · buscador · «losartam»',
    sql: `SELECT * FROM public.buscar_productos_minmax('losartam', 20)` },
  { clave: 'busq-minmax-nada', nota: 'Mín·Máx · buscador · «zzqxwv»',
    sql: `SELECT * FROM public.buscar_productos_minmax('zzqxwv', 20)` },
  { clave: 'busq-promo-existe', nota: 'Promociones · productos · «amox»',
    sql: `SELECT * FROM public.get_productos_para_promocion('amox', NULL, 400)` },
  { clave: 'busq-promo-nada', nota: 'Promociones · productos · «zzqxwv»',
    sql: `SELECT * FROM public.get_productos_para_promocion('zzqxwv', NULL, 400)` },
  { clave: 'busq-conteo-existe', nota: 'Conteo · página de productos · «amoxicilina»',
    sql: `SELECT * FROM public.get_conteo_products_page((SELECT id FROM public.conteos_inventario ORDER BY created_at DESC LIMIT 1), 'amoxicilina', 'TODOS', 25, 0, NULL, NULL, 'asc', NULL)` },
  { clave: 'busq-conteo-numero', nota: 'Conteo · página de productos · «500»',
    sql: `SELECT * FROM public.get_conteo_products_page((SELECT id FROM public.conteos_inventario ORDER BY created_at DESC LIMIT 1), '500', 'TODOS', 25, 0, NULL, NULL, 'asc', NULL)` },
  { clave: 'busq-conteo-nada', nota: 'Conteo · página de productos · «zzqxwv»',
    sql: `SELECT * FROM public.get_conteo_products_page((SELECT id FROM public.conteos_inventario ORDER BY created_at DESC LIMIT 1), 'zzqxwv', 'TODOS', 25, 0, NULL, NULL, 'asc', NULL)` },
  { clave: 'busq-conteo-aprox-typo', nota: 'Conteo · ¿fue aproximada? · «amoxisilina»',
    sql: `SELECT public.conteo_busqueda_aproximada((SELECT id FROM public.conteos_inventario ORDER BY created_at DESC LIMIT 1), 'amoxisilina')` },
  { clave: 'busq-conteo-aprox-nada', nota: 'Conteo · ¿fue aproximada? · «zzqxwv»',
    sql: `SELECT public.conteo_busqueda_aproximada((SELECT id FROM public.conteos_inventario ORDER BY created_at DESC LIMIT 1), 'zzqxwv')` },
  { clave: 'busq-ventas-cliente', nota: 'Ventas · búsqueda en el año · «maria»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('maria', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-producto', nota: 'Ventas · búsqueda en el año · «amoxicilina»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('amoxicilina', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-typo', nota: 'Ventas · búsqueda en el año · «amoxisilina»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('amoxisilina', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-numero', nota: 'Ventas · búsqueda en el año · «2.5»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('2.5', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-corta-y-larga', nota: 'Ventas · búsqueda en el año · «jo perez»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('jo perez', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-nada', nota: 'Ventas · búsqueda en el año · «zzqxwv»',
    sql: `SELECT count(*) FROM public.search_ventas_ids('zzqxwv', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-aprox-existe', nota: 'Ventas · ¿fue aproximada? · «maria»',
    sql: `SELECT public.ventas_busqueda_aproximada('maria', ${ANIO}, current_date)` },
  { clave: 'busq-ventas-aprox-nada', nota: 'Ventas · ¿fue aproximada? · «zzqxwv»',
    sql: `SELECT public.ventas_busqueda_aproximada('zzqxwv', ${ANIO}, current_date)` },
  { clave: 'busq-clientes-existe', nota: 'Clientes · página · «jose»',
    sql: `SELECT * FROM public.get_customers_page(p_search => 'jose', p_limit => 25)` },
  { clave: 'busq-clientes-dos', nota: 'Clientes · página · «maria lopez»',
    sql: `SELECT * FROM public.get_customers_page(p_search => 'maria lopez', p_limit => 25)` },
  { clave: 'busq-clientes-typo', nota: 'Clientes · página · «gonsales»',
    sql: `SELECT * FROM public.get_customers_page(p_search => 'gonsales', p_limit => 25)` },
  { clave: 'busq-clientes-numero', nota: 'Clientes · página · «0614»',
    sql: `SELECT * FROM public.get_customers_page(p_search => '0614', p_limit => 25)` },
  { clave: 'busq-clientes-nada', nota: 'Clientes · página · «zzqxwv»',
    sql: `SELECT * FROM public.get_customers_page(p_search => 'zzqxwv', p_limit => 25)` },
  { clave: 'busq-clientes-ids-existe', nota: 'Cotizaciones/anulaciones · clientes · «jose»',
    sql: `SELECT public.buscar_clientes_ids('jose', 30)` },
  { clave: 'busq-clientes-ids-nada', nota: 'Cotizaciones/anulaciones · clientes · «zzqxwv»',
    sql: `SELECT public.buscar_clientes_ids('zzqxwv', 30)` },
  { clave: 'busq-facturas-sala-existe', nota: 'Facturas de la sala · 30 días · «maria»',
    sql: `SELECT public.buscar_facturas_sala_ids(4, current_date - 30, current_date, 'maria', NULL, 50)` },
  { clave: 'busq-facturas-sala-nada', nota: 'Facturas de la sala · 30 días · «zzqxwv»',
    sql: `SELECT public.buscar_facturas_sala_ids(4, current_date - 30, current_date, 'zzqxwv', NULL, 50)` },
  { clave: 'busq-personas-existe', nota: 'Solicitudes de datos · personas · «jose»',
    sql: `SELECT * FROM public.buscar_personas_por_nombre('jose')` },
  { clave: 'busq-personas-nada', nota: 'Solicitudes de datos · personas · «zzqxwv»',
    sql: `SELECT * FROM public.buscar_personas_por_nombre('zzqxwv')` },
  { clave: 'busq-medicos-existe', nota: 'Bitácoras · médicos · «garcia»',
    sql: `SELECT public.buscar_medicos_ids('garcia', 'P01', 15)` },
  { clave: 'busq-medicos-typo', nota: 'Bitácoras · médicos · «garsia»',
    sql: `SELECT public.buscar_medicos_ids('garsia', 'P01', 15)` },
  { clave: 'busq-medicos-nada', nota: 'Bitácoras · médicos · «zzqxwv»',
    sql: `SELECT public.buscar_medicos_ids('zzqxwv', 'P01', 15)` },
  { clave: 'busq-notif-existe', nota: 'Notificaciones · 60 días · «pedido»',
    sql: `SELECT * FROM public.notificaciones_que_coinciden('pedido', now() - interval '60 days')` },
  { clave: 'busq-notif-nada', nota: 'Notificaciones · 60 días · «zzqxwv»',
    sql: `SELECT * FROM public.notificaciones_que_coinciden('zzqxwv', now() - interval '60 days')` },
  { clave: 'busq-compras-existe', nota: 'Compras · proveedor (lectura directa) · «f[aáàäâ]rm[aáàäâ]c»',
    sql: `SELECT id FROM public.purchase_receipts WHERE proveedor ~* 'f[aáàäâ]rm[aáàäâ]c' ORDER BY fecha DESC LIMIT 25` },
  { clave: 'busq-compras-nada', nota: 'Compras · proveedor (lectura directa) · «zzqxwv»',
    sql: `SELECT id FROM public.purchase_receipts WHERE proveedor ~* 'zzqxwv' ORDER BY fecha DESC LIMIT 25` },
];
