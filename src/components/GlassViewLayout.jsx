    ...
    return (
        ...
        <div className="max-w-[1440px] xl:max-w-[1600px] 2xl:max-w-[1800px] mx-auto lg:h-full w-full font-sans relative">
            ...
            <div
                ...
                className={`lg:absolute lg:inset-0 lg:w-full lg:h-full pb-[calc(2.5rem+var(--alto-barra-flotante,0px))] lg:flex lg:flex-col [&::-webkit-scrollbar]:hidden overflow-x-hidden ${
