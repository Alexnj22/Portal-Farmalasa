...
function useTokens() {
  ...
  return {
    ...
    // toolbar separator (below toolbar / above thead)
    toolbarBorder: isCompat
      ? 'border-b border-slate-100'
      : isAurora
      ? 'border-b border-white/[0.07]'
      : 'border-b border-white/40',
    // footer separator (above footer / below tbody)
    ...
    // expanded detail row (read via useExpandStyle)
    expandBg: isCompat
      ? 'bg-slate-50'
      : isAurora
      ? 'bg-white/[0.04]'
    ...
    expandBorderColor: isCompat
      ...
      ? 'border-white/[0.06]'
      : 'border-blue-100/60',
    expandText: isAurora ? 'text-white/60' : 'text-slate-400',
