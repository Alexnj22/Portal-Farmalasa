    ...
    return (
        <div className="space-y-6 w-full" style={gpuLockStyle}>
            ...
            <div className={`bg-white/60 rounded-[2rem] p-6 border border-white/80 shadow-[0_4px_20px_rgba(0,0,0,0.03)] transform-gpu ${islandHoverClass}`} style={gpuLockStyle}>
                ...
                {isRented ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 bg-white/40 p-5 rounded-[1.5rem] border border-white/60 shadow-[inset_0_2px_10px_rgba(255,255,255,0.5)]">
                        ...
                        {rentContract.endDate && (
                            <div className="md:col-span-2 flex items-center gap-3 bg-amber-50/80 border border-amber-200 p-3 rounded-2xl">
                    ...
                    <div className="py-10 text-center bg-white/40 rounded-[1.5rem] border border-white/60 shadow-[inset_0_2px_10px_rgba(255,255,255,0.5)]">
