...
const BranchTabLegal = ({
    ...
    const islandHoverClass = "transition-all duration-500 ease-[var(--ease-spring)] hover:translate-y-[var(--lift-card)] hover:shadow-[var(--shadow-elevation-sm)] hover:bg-surface-card hover:border-border-card";
