    ...
    return (
        <div className="flex flex-col md:flex-row gap-6 h-full animate-in fade-in slide-in-from-bottom-4 duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]">
            ...
            {/* =========================================================
                ...
                ========================================================= */}
            <div className="w-full md:w-5/12 bg-surface-card backdrop-blur-[30px] backdrop-saturate-[180%] rounded-header border border-border-card shadow-[0_20px_40px_rgba(0,0,0,0.05),inset_0_2px_20px_rgba(255,255,255,0.8)] p-7 flex flex-col relative overflow-hidden shrink-0 transform-gpu backface-hidden transition-all duration-700 hover:shadow-[var(--shadow-elevation-lg)] hover:-translate-y-1 group/main">
