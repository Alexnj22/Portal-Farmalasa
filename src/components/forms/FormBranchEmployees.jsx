                            ...
                            return (
                                <div key={slot.id} className="flex items-center gap-4 p-5 rounded-[1.5rem] border-2 border-dashed border-danger/30 bg-danger/10 backdrop-blur-sm h-[100px]">
                                    ...
                                    <div className="flex flex-col">
                                        <h4 className="text-[12px] font-bold text-content-2 leading-tight">{slot.roleName}</h4>
                                        <p className="text-[9px] font-black uppercase tracking-widest mt-1 text-danger flex items-center gap-1">
                            ...
                            <div key={slot.id} onClick={(e) => handleViewEmployee(e, emp)} className="group relative overflow-hidden cursor-pointer rounded-[1.5rem] bg-surface-card backdrop-blur-md border border-border-card shadow-[0_8px_30px_rgba(0,0,0,0.04)] h-[100px] active:scale-[0.97] transition-all">
                                ...
                                <div className="absolute inset-0 p-5 flex items-center gap-4 transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:-translate-y-4 group-hover:opacity-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h4 className="text-[14px] font-black text-content truncate leading-tight">{emp.name}</h4>
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-content-3 mt-1 block truncate">{slot.roleName}</span>
                                    </div>
                                </div>
