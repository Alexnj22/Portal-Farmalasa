                                                        ...
                                                        {formData.outgoingAction === 'REASSIGN' && (
                                                            <div className="mt-4 grid grid-cols-1 gap-4 animate-in fade-in slide-in-from-top-2 w-full">
                                                                <div className="space-y-1.5">
                                                                    ...
                                                                    <div className="rounded-2xl transition-all duration-300 transform-gpu hover:translate-y-[var(--lift-card)] hover:shadow-md border border-transparent">
                                                                        <LiquidSelect 
                                ...
                                <div className="space-y-4">
                                    ...
                                    {formData.isPermanent === false && (
                                        <div data-surface="card" className="border-warning/30 p-5 animate-in slide-in-from-top-2">
                                            ...
                                            <div className="transition-all duration-300 transform-gpu hover:translate-y-[var(--lift-card)] hover:shadow-md rounded-2xl">
                                                <LiquidDatePicker 
