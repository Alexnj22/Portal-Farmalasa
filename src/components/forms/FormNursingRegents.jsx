        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-2 pt-2">
            ...
            <div className="bg-surface-card backdrop-blur-xl border border-border-card p-6 rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:bg-surface-card transition-all duration-500 transform-gpu space-y-5">
                ...
                <div>
                    ...
                    <div className={`relative group border-2 border-dashed rounded-[1.5rem] p-4 transition-all duration-300 transform-gpu hover:-translate-y-0.5 hover:shadow-md flex items-center gap-4 cursor-pointer overflow-hidden ${legalData.nursingServicePermitFile || legalData.nursingServicePermitUrl ? 'bg-chart-1/10/50 border-chart-1/40 hover:bg-chart-1/10' : 'bg-surface-card-hover/50 border-slate-300 hover:bg-brand/5 hover:border-brand/50'}`}>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100 pt-5">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className={`relative group/btn border-2 border-dashed rounded-2xl p-3 transition-all duration-300 transform-gpu hover:-translate-y-0.5 hover:shadow-md flex items-center gap-3 cursor-pointer ${nurse.carneFile || nurse.carneUrl ? 'bg-chart-1/10/40 border-chart-1/30 hover:bg-chart-1/10/80' : 'bg-surface-card-hover/50 border-slate-200 hover:bg-brand/5 hover:border-brand/40'}`}>
                                            ...
                                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 border transition-all duration-300 group-hover/btn:scale-105 ${nurse.carneFile || nurse.carneUrl ? 'bg-white text-brand shadow-sm border-chart-1/30' : 'bg-white text-content-3 border-slate-100 group-hover/btn:text-brand'}`}>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className={`relative group/btn border-2 border-dashed rounded-2xl p-3 transition-all duration-300 transform-gpu hover:-translate-y-0.5 hover:shadow-md flex items-center gap-3 cursor-pointer ${nurse.licenciaFile || nurse.licenciaUrl ? 'bg-chart-1/10/40 border-chart-1/30 hover:bg-chart-1/10/80' : 'bg-surface-card-hover/50 border-slate-200 hover:bg-brand/5 hover:border-brand/40'}`}>
                                            ...
                                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 border transition-all duration-300 group-hover/btn:scale-105 ${nurse.licenciaFile || nurse.licenciaUrl ? 'bg-white text-brand shadow-sm border-chart-1/30' : 'bg-white text-content-3 border-slate-100 group-hover/btn:text-brand'}`}>
                                ...
                                <div className="bg-gradient-to-br from-amber-50/80 to-amber-100/30 p-4 rounded-2xl border border-warning/30 shadow-inner mt-2 transition-all duration-500 hover:shadow-sm">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="group/date-amber flex flex-col justify-end">
                                            <label className="text-[9px] font-black text-warning/80 uppercase tracking-widest ml-1 mb-1 block group-focus-within/date-amber:text-warning-text transition-colors">Vencimiento</label>
