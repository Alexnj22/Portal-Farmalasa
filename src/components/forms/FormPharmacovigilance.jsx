        ...
        return (
            <div className="bg-warning/10 backdrop-blur-xl border border-warning/30 p-8 rounded-[2rem] flex flex-col items-center text-center shadow-[0_8px_30px_rgba(245,158,11,0.12)] animate-in fade-in slide-in-from-bottom-4 duration-500 m-2">
                ...
                <button 
                    type="button" 
                    onClick={onClose} 
                    className="px-8 py-3.5 bg-white text-warning font-black text-[11px] uppercase tracking-widest rounded-2xl hover:bg-amber-500 hover:text-white border border-warning/30 hover:border-amber-500 transition-all duration-300 shadow-sm hover:shadow-[0_8px_20px_rgba(245,158,11,0.3)] hover:-translate-y-0.5 active:scale-[0.97]"
                >
                    Entendido, Cerrar
                </button>
            </div>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-2 pt-2">
            ...
            <div className="bg-surface-card backdrop-blur-xl border border-border-card p-6 md:p-8 rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgba(147,51,234,0.08)] hover:-translate-y-1 hover:bg-surface-card transition-all duration-500 transform-gpu space-y-6">
                ...
                <div className="group/select">
                    <label className="text-[10px] font-black text-content-3 uppercase tracking-widest ml-1 mb-1.5 block group-focus-within/select:text-purple-600 transition-colors">
                ...
                <div>
                    ...
                    <div className={`relative group border-2 border-dashed rounded-[1.5rem] p-4 transition-all duration-300 transform-gpu hover:-translate-y-0.5 hover:shadow-md flex items-center gap-4 cursor-pointer overflow-hidden ${legalData.farmacovigilanciaAuthFile || legalData.farmacovigilanciaAuthUrl ? 'bg-purple-50/50 border-purple-300 hover:bg-purple-50/80' : 'bg-surface-card-hover/50 border-slate-300 hover:bg-purple-50/30 hover:border-purple-300/60'}`}>
                        ...
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-sm shrink-0 transition-all duration-300 group-hover:scale-105 ${legalData.farmacovigilanciaAuthFile || legalData.farmacovigilanciaAuthUrl ? 'bg-white text-purple-600 border border-purple-200' : 'bg-white text-content-3 border border-slate-100 group-hover:text-purple-500 group-hover:border-purple-200'}`}>
                        ...
                        <div className="flex-1 min-w-0">
                            <p className={`text-[12px] font-black tracking-tight truncate ${legalData.farmacovigilanciaAuthFile || legalData.farmacovigilanciaAuthUrl ? 'text-purple-700' : 'text-content-2'}`}>
