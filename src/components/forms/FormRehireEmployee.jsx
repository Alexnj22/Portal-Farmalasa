...
const reqBadge  = <span className="text-danger font-bold bg-danger/10 px-2 py-0.5 rounded-md border border-danger/30 text-[9px]">Requerido</span>;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <textarea value={formData.rehire_notes || ''} onChange={e => set('rehire_notes', e.target.value)}
                            ...
                            className={`w-full bg-surface-card rounded-[1rem] border border-divider shadow-sm text-[16px] font-medium text-content-2 outline-none px-4 py-2.5 resize-none ${inputHover}`} />
                    </div>
