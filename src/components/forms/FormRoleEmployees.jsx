...
const FormRoleEmployees = ({ formData }) => {
    ...
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="relative p-8 md:p-10 pb-8 overflow-hidden bg-gradient-to-b from-[#0052CC]/5 to-transparent border-b border-slate-100/50 rounded-t-[2.5rem]">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#0052CC]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
                <div className="relative flex items-center gap-5">
                    <div className="w-16 h-16 rounded-[1.2rem] bg-[#0052CC] text-white flex items-center justify-center shadow-[0_8px_20px_rgba(0,82,204,0.3)] shrink-0">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] md:text-[11px] font-black text-[#0052CC] uppercase tracking-widest flex items-center gap-1.5">
