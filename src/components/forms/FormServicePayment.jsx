...
const SERVICE_CONFIG = {
 ...
 water: { title: 'Agua Potable', icon: Droplet, color: 'text-chart-5-text bg-chart-5/10 border-chart-5/30', ring: 'focus:border-chart-5', providerLabel: 'Servicio de Agua' },
