            ...
            <div>
                ...
                <div className="relative flex items-center">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 bg-white border border-slate-200/80 rounded-[1rem] h-[44px] text-[16px] font-bold text-content-2 outline-none transition-all hover:border-brand/30 focus:ring-4 focus:ring-brand/10 focus:border-brand/50"
                    />
                </div>
            </div>
