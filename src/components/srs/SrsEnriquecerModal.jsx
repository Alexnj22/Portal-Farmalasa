...
const AUTO_MIN         = 0.46;  // >= auto-apply
const REVIEW_MIN       = 0.18;  // >= show for review, else skip
                    ...
                    {phase === PHASE.IDLE && (
                        <div className="flex flex-col items-center gap-4 py-6 text-center">
                            ...
                            <div className="flex gap-4 text-[11px] font-bold">
                                <span className="flex items-center gap-1.5 text-emerald-600"><span className="w-2.5 h-2.5 rounded-full bg-emerald-400 inline-block"/> ≥ 46% — auto-aplica</span>
                                <span className="flex items-center gap-1.5 text-amber-600"><span className="w-2.5 h-2.5 rounded-full bg-amber-400 inline-block"/> 18–45% — te consulta</span>
                                <span className="flex items-center gap-1.5 text-slate-400"><span className="w-2.5 h-2.5 rounded-full bg-slate-300 inline-block"/> {'< 18%'} — descarta</span>
                            </div>
