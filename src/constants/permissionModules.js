...
export const MODULE_GROUPS = [
    ...
    },
    {
        ...
        modules: [
            ...
            { key: 'dash_inv_movement',   label: 'Widget: Carga y Descarte',      desc: 'Solicitar que se cargue o se descarte producto —vencimiento, descarte, producto dañado o consumo interno—; el inventario se mueve al aprobarla', icon: PackageMinus, hasApprove: false, hasScope: true },
