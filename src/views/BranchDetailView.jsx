                    ...
                    <div className="flex items-center h-full shrink-0 origin-right animate-in fade-in zoom-in-95 duration-[var(--dur-slow)]">
                        ...
                        <div inert={isEditMode ? true : undefined} className={`overflow-hidden transition-all duration-[var(--dur-lento)] ease-[var(--ease-spring)] ${isEditMode ? 'max-w-0 opacity-0 pointer-events-none' : 'max-w-[800px] opacity-100'}`}>
                            <div ref={tabsRef} className="flex items-center gap-1 md:gap-2 pr-1 md:pr-2 w-max relative">
                                <div
                                    className="absolute top-0 bottom-0 bg-white rounded-full shadow-[var(--shadow-elevation-sm)] transition-all duration-[var(--dur-lento)] ease-[var(--ease-spring)]"
        ...
        <>
                        ...
                        >
                            ...
                            <span className="text-micro md:text-caption font-bold text-content-2 uppercase tracking-widest">
                                {(liveBranch?.openingDate || liveBranch?.opening_date)
                                    ? `Inaugurada en ${fechaTexto(liveBranch.openingDate || liveBranch.opening_date, { month: 'long', year: 'numeric' })}`
            ...
            >
                <div className="w-full flex-1 flex flex-col relative z-base pb-12">
                    ...
                    <div data-surface="card" className="p-6 md:p-8 min-h-[700px] relative overflow-hidden flex flex-col w-full mt-2">
