...
const LoginView = ({ setView, setActiveEmployee }) => {
    ...
    const [isSmallLayout, setIsSmallLayout] = useState(() => window.innerWidth < 1024);
    ...
    useEffect(() => {
        const handler = () => setIsSmallLayout(window.innerWidth < 1024);
    ...
    return (
        <div className="relative w-full min-h-[100dvh]">
            {isSmallLayout ? (
                /* ── SPLIT LAYOUT (< 1024px): Kiosco izquierda | Login derecha ── */
                <div className="flex w-full min-h-[100dvh]">
                    ...
                    >
                        <div className="p-5 bg-white/10 rounded-3xl border border-white/10
                            ...
                            <Clock size={44} className="text-white" strokeWidth={1.5} />
                        </div>
                        <div className="text-center">
                            <p className="text-white font-black text-[15px] uppercase tracking-widest leading-tight">Terminal</p>
                            <p className="text-white font-black text-[15px] uppercase tracking-widest leading-tight">Kiosco</p>
                            <p className="text-white/50 text-[10px] mt-2 uppercase tracking-widest font-bold">
                    ...
                    {/* Columna derecha: Formulario de login (60%) */}
                    <div className="w-[60%] flex flex-col items-center justify-center
                        bg-white/50 backdrop-blur-3xl p-6 gap-4 overflow-y-auto">
                        ...
                        {/* Tabs Carné / Usuario */}
                        <div className="flex bg-white/30 backdrop-blur-md border border-white/60
                            rounded-[2rem] p-1 w-full shadow-[inset_0_2px_8px_rgba(0,0,0,0.02)]">
                            <button type="button"
                        ...
                        <form onSubmit={loginMode === 'username' ? handleUsernameLogin : handleLogin}
                            ...
                            {error && (
                                <div className="px-4 py-2.5 bg-red-50/50 border border-red-200/80
                                    rounded-[1.25rem] flex items-center gap-2">
                                    <AlertCircle size={15} className="text-red-500 shrink-0" strokeWidth={2.5} />
                                    <p className="text-red-600 text-[9px] font-black uppercase tracking-widest">{error}</p>
                                </div>
                            )}
                ...
                /* ── DESKTOP LAYOUT (>= 1024px) — sin cambios ── */
