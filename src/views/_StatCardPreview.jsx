    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-10 flex flex-col gap-10">
            ...
            <section>
                ...
                <div className="flex items-stretch gap-3">
                    <StatCard icon={TrendingUp} iconBg="bg-emerald-50" label="Total Ventas" value="" loading />
                    <StatCard icon={FileText}   iconBg="bg-blue-50"    label="Facturas"     value="" loading />
                    <StatCard icon={Star}       iconBg="bg-amber-50"   label="Pts. Canjeados" value="" sub="este período" loading />
                </div>
            </section>
