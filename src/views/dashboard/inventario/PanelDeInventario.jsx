// ─────────────────────────────────────────────────────────────────────────────
// EL CUERPO DEL BUSCADOR DE INVENTARIO — todo lo que sólo existe con el modal
// abierto
// ─────────────────────────────────────────────────────────────────────────────
//
// Separado de `WidgetInventorySearch.jsx` el 2026-08-23. Son 1,180 de las 1,414
// líneas que tenía el archivo, y viajaban en el cierre estático del Inicio —o
// sea que las bajaba TODO el que entra al portal, para un modal que la mayoría
// de las visitas no abre.
//
// El propio baseline del gate de peso ya lo señalaba como el próximo corte:
// «WidgetInventorySearch (9.6 kB) — ahí el cuerpo del modal SÍ se puede separar
// del azulejo, y el azulejo ya lo invoca por render-prop». Estaba escrito y
// nadie lo había hecho; el Inicio quedó en 100 kB contra un techo de 99 y el
// gate en rojo.
//
// La baldosa se queda con lo suyo: el número de faltantes, la franja de a qué
