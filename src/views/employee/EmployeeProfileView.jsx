            ...
            <div className="pt-24 px-4 md:px-6 pb-10 flex flex-col lg:flex-row gap-6 items-start">
                ...
                <div className="w-full lg:w-[360px] shrink-0 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button onClick={() => openModal('editContact', emp)} className="flex items-center justify-center gap-2 py-3 rounded-2xl bg-[#007AFF] text-white text-[11px] font-black uppercase tracking-widest shadow-[0_4px_12px_rgba(0,122,255,0.3)] hover:bg-[#0066DD] transition-all active:scale-95">
                            <Edit3 size={13} strokeWidth={2.5} /> Editar Perfil
                        </button>
                        <button onClick={() => openModal('changeOwnPassword', {})} className="flex items-center justify-center gap-2 py-3 rounded-2xl bg-white/70 border border-white/80 text-amber-600 text-[11px] font-black uppercase tracking-widest shadow-sm hover:bg-amber-50 transition-all active:scale-95">
