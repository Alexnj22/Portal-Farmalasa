...
// MotorcycleAnim, BoxStackAnim, PausedAnim, VioletGlow, ScanAnim, PingDot,
// StageAnim, EmpChip, StagePill, SucPill: extraídos a ./tabpedidos/
// (Bloque 6.C) — importados arriba. (Hallazgo de paso, sin tocar: StageAnim/
// EmpChip/StagePill no tienen ningún caller en este archivo — quedan
// extraídos igual, sin uso hoy, no se investigó más a fondo por estar fuera
// de alcance de esta extracción.)

// PauseModal, AnularModal, ApoioScanModal: extraídos a ./tabpedidos/
