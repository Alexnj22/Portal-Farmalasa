                    ...
                    <>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full text-input border border-divider rounded-xl px-3 py-2 focus:outline-none focus:border-danger bg-surface-card resize-none transition-colors text-content-2"
                            />
