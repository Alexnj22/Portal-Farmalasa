        ...
        <PedidoModal onClose={onCancel}>
            <PedidoModal.Header>
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-danger flex items-center justify-center shadow-sm shrink-0">
                        <Ban size={20} className="text-white" />
                    </div>
                    <div>
                        <h3 className="font-bold text-content text-subtitle">Anular pedido</h3>
                        <p className="text-body-sm text-content-2 mt-0.5">#{modal?.numero}</p>
                    </div>
                </div>
            </PedidoModal.Header>
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full text-body-xl border border-divider rounded-xl px-3 py-2 focus:outline-none focus:border-danger bg-surface-card resize-none transition-colors text-content-2"
                            />
