                                        ...
                                        <div className="px-4 pb-3 pt-1">
                                            ...
                                            {(promo.promotion_products || []).map(pp => {
                                                ...
                                                const ppPct = pp.stock_inicial && pp.stock_inicial > 0
                                                    ...
                                                    : null;
                                                return (
                                                    <div key={pp.id} className="flex items-center gap-3 py-1.5 border-b border-divider last:border-0">
                                                        <div className="w-6 h-6 rounded bg-surface-card-hover border border-divider flex items-center justify-center overflow-hidden">
