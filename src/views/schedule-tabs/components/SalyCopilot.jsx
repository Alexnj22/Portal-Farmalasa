...
const SalyCopilot = ({ aiCopilotAlerts }) => {
    ...
    return (
        ...
        <div className={`col-span-1 ${aiBoxBg} backdrop-blur-3xl backdrop-saturate-[180%] border rounded-modal p-3.5 shadow-[var(--shadow-glass-lg)] text-white flex flex-col relative overflow-hidden transition-all duration-500 group/ai h-full max-h-[210px]`}>
