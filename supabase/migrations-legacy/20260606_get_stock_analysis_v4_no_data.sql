-- get_stock_analysis v4: agrega tercer UNION ALL para productos activos sin params ni inventario (no_data)
-- Preserva is_hidden (hidden_products_is_hidden_v2)
-- Permite editar MIN/MAX de dead-stock y no-data productos desde el frontend
...
AS $function$
  ...
  FROM (
    -- Productos con fila en product_stock_params (tienen historial calculado)
    SELECT
