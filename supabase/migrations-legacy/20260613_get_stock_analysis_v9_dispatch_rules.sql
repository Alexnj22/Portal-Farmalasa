-- get_stock_analysis v9: LEFT JOIN dispatch_rules en el SELECT externo
-- Añade 4 columnas: dispatch_solo_cajas, dispatch_multiplo, dispatch_blister, dispatch_multiplo_unidades
-- Sin cambios a los 4 UNION branches — join en nivel externo sobre combined.
