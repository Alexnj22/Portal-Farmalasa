-- get_pedido_sucursal_stats + get_pedido_sin_bodega: fix presentaciones duplicadas
-- Mismo problema que get_pedido_preview v22: inv_agg pre-agrega; DISTINCT ON elige
-- una presentación por (suc, producto) — la de mayor factor donde ROUND(max/factor)>=1.
