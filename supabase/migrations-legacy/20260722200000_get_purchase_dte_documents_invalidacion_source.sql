-- Pedido del usuario 2026-07-22: "como el caso de jamilu, que se pueda ver
-- el anulado asi como las notas de credito, que sale ver documento" — las
-- Notas de Crédito ya muestran un badge "Ver original" en la fila de
-- Documentos (documento_relacionado, ver get_purchase_dte_documents). Se
-- agrega el mismo patrón para documentos invalidado=true: si hay un PDF de
-- Revisión que lo justifica (ver classify_purchase_dte_review), se expone
-- como invalidacion_source para un badge equivalente "Ver anulación" sin
-- tener que abrir el detalle primero.
SET lock_timeout = '5s';
