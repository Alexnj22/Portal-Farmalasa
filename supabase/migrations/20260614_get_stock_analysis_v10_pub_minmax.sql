-- get_stock_analysis v10: añade pub_min y pub_max (min_units/max_units publicados, sin override manual).
-- Requerido para: validar que overrides manuales de Bodega sean >= Σ sucursales,
--                y para mostrar "Σ N·N" bajo el valor manual en la celda MIN·MAX.
