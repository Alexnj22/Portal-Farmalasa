-- ============================================================
-- get_pedidos_en_curso v4
-- Incluye pedidos completado/parcial de los últimos 7 días
-- para que las sucursales puedan ver el pedido después de
-- procesarlo sin que desaparezca inmediatamente del portal.
-- Activos primero, luego completados (por fecha DESC).
-- anulado sigue excluido siempre.
-- ============================================================
