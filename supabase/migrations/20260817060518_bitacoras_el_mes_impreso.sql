...
-- RTS 6.1.14: «Toda la documentacion solicitada por este reglamento debe estar
-- disponible dentro del establecimiento; PREFERIBLEMENTE debe estar de manera
-- fisica». La norma prefiere el papel, asi que el mes tiene que poder salir
-- impreso con la forma que un inspector reconoce.
--
-- Devuelve TODO el mes de una sucursal en UN objeto: resumen, la grilla dia a
-- dia con sus huecos, la limpieza y el libro foliado. Uno y no cuatro llamadas
-- porque lo que se imprime tiene que ser una foto coherente: cuatro consultas
-- separadas pueden caer a cada lado de un cambio y el papel se contradiria.
