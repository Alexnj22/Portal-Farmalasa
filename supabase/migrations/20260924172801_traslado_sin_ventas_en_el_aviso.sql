...
-- El aviso de traslado deja de llevar las ventas de cada producto: queda lo que
-- se pide, la cantidad y cuánto hay en la sala (usuario, 24-sep).
-- `ventas_por_mes_de_producto` sigue: la usa el aviso de MIN·MAX.
