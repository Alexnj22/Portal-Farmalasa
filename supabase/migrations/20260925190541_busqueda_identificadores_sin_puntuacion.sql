-- Un identificador (6+ dígitos) se busca también en la forma SIN puntuación:
-- un NIT o un teléfono se guardan con guiones («0614-150385-102-3») y se
-- escriben seguidos («06141503851023»). Mismo cambio en src/utils/busqueda.js;
-- 5 casos nuevos en tests/casos-busqueda.json y `npm run busqueda:gemelos`.
SET lock_timeout = '5s';
